...
class main {
	...
	public function get() {
		...
		if ($searchresult) {
			...
			$tpl->setVar('servergroup', htmlentities($data['servergroup']));
			$tpl->setVar('os', htmlentities($data['os']));
	...
	private function listchildren($children) {
		...
		foreach ($children as $child) {
			...
			$tpl->setVar('servergroup', htmlentities($child['servergroup']));
			$tpl->setVar('os', htmlentities($child['os']));
